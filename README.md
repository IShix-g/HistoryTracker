...
> [!IMPORTANT]
> このプラグインは保存されたゲームデータを保存/復元するプラグインです。データのシリアライズ/デシリアライズなど、セーブシステムは含まれておりません。
...
| ③  | プラグインの有効範囲                  |
| ④  | Editorで保存したゲームデータを実機に書き出すか？ |

## スクリプトからゲームデータを保存する

ヒストリーダイアログのSaveボタンを押して保存できますが、下記コードでも保存できます。
